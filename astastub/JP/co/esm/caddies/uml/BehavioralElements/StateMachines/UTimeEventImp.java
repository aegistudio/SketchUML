...
public class UTimeEventImp extends JP.co.esm.caddies.uml.BehavioralElements.StateMachines.UEventImp
    implements java.io.Serializable {
    public static final long serialVersionUID = -1200126902461827169L;

    public JP.co.esm.caddies.uml.Foundation.DataTypes.UTimeExpression when;
}
