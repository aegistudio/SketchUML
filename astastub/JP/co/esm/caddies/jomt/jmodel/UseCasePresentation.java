...
public class UseCasePresentation extends JP.co.esm.caddies.jomt.jmodel.ClassifierPresentation
    implements java.io.Serializable {
    public static final long serialVersionUID = 5485714905344378580L;

    public boolean withinOvalName;

    public boolean stereotypeAboveOval;
}
